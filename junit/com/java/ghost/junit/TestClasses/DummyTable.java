...
import com.java.ghost.utils.GhostDBStaticVariables.DBOwnerList;

@MetaTableInfo(unqualifiedTableName ="DUMMY", schema = DBOwnerList.OWNER)
public final class DummyTable extends AbstractMetaTable implements IMetaGhostVariableTable{
...
//	@MetaTablePartitionColumn
	...
	public DummyTable(String tableAlias){
		super.initMetaTableObject();
