...
import com.java.ghost.Annotations.AdditionalPossessColumnsMethod;
import com.java.ghost.DBStatementExecutor.DBStatementExecutor;
import com.java.ghost.Exceptions.GhostRuntimeException;
import com.java.ghost.GhostAttributes.GhostPossessMapping;
...
import com.java.ghost.utils.GhostUtils;
...
//                                                                               GhostDBStaticVariables.GHOST_BLOB_UTIL_POSSESSBULK_ARGS + GhostDBStaticVariables.CLOSE_BRACKET;
 ...
 static{
		...
		try {
            Class<com.java.ghost.Variable.PossessWrapper> thisClass = com.java.ghost.Variable.PossessWrapper.class;        
